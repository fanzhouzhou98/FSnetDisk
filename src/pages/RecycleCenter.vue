    ...
    <div v-loading="loading" class="wait" style="height:300px;">
      <el-form ref="searchForm" :model="searchForm" :inline="true" size="mini">
        <el-form-item prop="name" label="文件名">
         ...
         <el-form-item prop="name" label="删除日期">
            <el-date-picker
              v-model="dateArr"
              type="daterange"
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" @click="getFileList"
            >查询</el-button
          >
      ...
      <div class="displayContent">
        <el-table :data="fileList" style="width: 100%" border>
          ...
          <el-table-column
            ...
            width="180"
          />
          <el-table-column prop="updatedAt" label="删除时间" sortable align="center" width="180" />
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                type="danger"
                size="mini"
                @click="realDeleteFile(scope.row)"
                >永久删除
              </el-button>
            </template>
          </el-table-column>
